...
namespace FlytekStore_MVVM.Data
{
    // Clase sencilla para manejar la conexión con SQL Server
    // y realizar las consultas básicas (solo lectura de momento)
    public class GestorBD
    {
        // Cadena de conexión (ajústala si tu servidor o base cambian)
        private string cadenaConexion = @"Server=LAZARO-PC\SQLEXPRESS;Database=FlytekDB;Trusted_Connection=True;";
        ...
        // Método muy básico que hice para registrar las compras en la base de datos.
        ...
        // -------------------------------------------------------------
        // Me basé en los apuntes del tema T-SQL y Acceso a Datos (ADO.NET).
